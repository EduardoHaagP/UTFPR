...
// variaveis
float nota1Aluno1, nota2Aluno1,mediaAluno1; // aluno1
float nota1Aluno2, nota2Aluno2, mediaAluno2; // aluno2
float nota1Aluno3, nota2Aluno3, mediaAluno3; // aluno3
float nota1Aluno4, nota2Aluno4, mediaAluno4; // aluno4
float nota1Aluno5, nota2Aluno5, mediaAluno5; // aluno5
float mediaTodosAlunos;                      // todos
...
int main()
{
    ...
    do
    {
        printf("Digite as notas do primeiro aluno\n Siga o padrao N1 N2\n");
            scanf("%f %f", &nota1Aluno1, &nota2Aluno1);
    ...
    do
    {
        printf("Digite as notas do segundo aluno\n Siga o padrao N1 N2\n");
            scanf("%f %f", &nota1Aluno2, &nota2Aluno2);
    ...
    do
    {
        ...
        scanf("%f %f", &nota1Aluno3, &nota2Aluno3);
